...
class FixedBackground2:
    ...
    def update(self):
        self.window_left = int(server2.boy2.x) - self.cw//2
        self.window_bottom = int(server2.boy2.y) - self.ch//2
...
class InfiniteBackground:
    ...
    def update(self):
        ...
        # quadrant 3
        self.q3l = (int(server2.boy2.x) - self.cw // 2) % self.w
        self.q3b = (int(server2.boy2.y) - self.ch // 2) % self.h
